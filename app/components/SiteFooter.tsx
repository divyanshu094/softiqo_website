      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:px-10">
        <div className="space-y-4">
          ...
          <p className="max-w-md text-sm leading-6 text-[color:var(--muted)]">
            Softiqo Technologies delivers digital products, software
            engineering, and cloud solutions that help teams build faster and
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 text-sm text-[color:var(--muted)]">
            <Link
              href="/aboutus"
              className="block transition hover:text-[color:var(--foreground)]"
            >
              About Us
            </Link>
            <Link
